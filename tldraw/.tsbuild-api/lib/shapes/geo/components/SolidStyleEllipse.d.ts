...
export declare const SolidStyleEllipse: React.NamedExoticComponent<Pick<{
...
export declare function SolidStyleEllipseSvg({ w, h, strokeWidth: sw, fill, color, theme, }: Pick<TLGeoShape['props'], 'color' | 'fill' | 'h' | 'w'> & {
    strokeWidth: number;
    theme: TLDefaultColorTheme;
}): SVGElement;
//# sourceMappingURL=SolidStyleEllipse.d.ts.map