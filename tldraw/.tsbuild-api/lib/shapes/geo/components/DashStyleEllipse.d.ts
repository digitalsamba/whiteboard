...
export declare const DashStyleEllipse: React.NamedExoticComponent<Pick<{
...
export declare function DashStyleEllipseSvg({ w, h, strokeWidth: sw, dash, color, theme, fill, }: Pick<TLGeoShape['props'], 'color' | 'dash' | 'fill' | 'h' | 'w'> & {
    strokeWidth: number;
    id: TLShapeId;
    theme: TLDefaultColorTheme;
}): SVGElement;
//# sourceMappingURL=DashStyleEllipse.d.ts.map