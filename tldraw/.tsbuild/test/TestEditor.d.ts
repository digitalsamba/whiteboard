...
export declare class TestEditor extends Editor {
     ...
     */
    _transformPointerDownSpy: jest.SpyInstance<TLPointerEventInfo | import("@tldraw/editor").TLClickEventInfo, [info: TLPointerEventInfo]>;
    _transformPointerUpSpy: jest.SpyInstance<TLPointerEventInfo | import("@tldraw/editor").TLClickEventInfo, [info: TLPointerEventInfo]>;
    ...
    pinchStart: (x: number | undefined, y: number | undefined, z: number, dx: number, dy: number, dz: number, options?: Partial<Omit<TLPinchEventInfo, "point" | "delta" | "offset">>) => this;
    pinchTo: (x: number | undefined, y: number | undefined, z: number, dx: number, dy: number, dz: number, options?: Partial<Omit<TLPinchEventInfo, "point" | "delta" | "offset">>) => this;
    pinchEnd: (x: number | undefined, y: number | undefined, z: number, dx: number, dy: number, dz: number, options?: Partial<Omit<TLPinchEventInfo, "point" | "delta" | "offset">>) => this;
     ...
     * @public
     */
    get selectionPageCenter(): Vec2d | null;
     ...
     * @public
     */
    getPageCenter(shape: TLShape): Vec2d | null;
    /**
