...
export declare const SolidStyleCloud: React.NamedExoticComponent<Pick<{
...
export declare function SolidStyleCloudSvg({ fill, color, strokeWidth, theme, w, h, id, size, }: Pick<TLGeoShape['props'], 'fill' | 'color' | 'w' | 'h' | 'size'> & {
    strokeWidth: number;
    theme: TLDefaultColorTheme;
    id: TLShapeId;
}): SVGElement;
//# sourceMappingURL=SolidStyleCloud.d.ts.map