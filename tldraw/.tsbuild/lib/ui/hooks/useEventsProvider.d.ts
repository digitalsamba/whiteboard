...
/** @public */
export type TLUiEventSource = 'menu' | 'context-menu' | 'zoom-menu' | 'navigation-zone' | 'quick-actions' | 'actions-menu' | 'kbd' | 'debug-panel' | 'page-menu' | 'share-menu' | 'export-menu' | 'toolbar' | 'people-menu' | 'dialog' | 'help-menu' | 'helper-buttons' | 'unknown';
/** @public */
