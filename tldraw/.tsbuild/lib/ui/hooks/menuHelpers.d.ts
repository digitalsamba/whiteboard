...
/** @public */
export declare function compactMenuItems<T>(arr: T[]): Exclude<T, null | false | undefined>[];
/** @public */
export declare function menuGroup(id: string, ...children: (TLUiMenuChild | null | false)[]): TLUiMenuGroup | null;
/** @public */
export declare function menuSubmenu(id: string, label: TLUiTranslationKey, ...children: (TLUiMenuChild | null | false)[]): TLUiSubMenu | null;
/** @public */
