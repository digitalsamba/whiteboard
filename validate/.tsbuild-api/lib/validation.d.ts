 ...
 * @public
 */
export declare function literal<T extends boolean | number | string>(expectedValue: T): Validator<T>;
/**
 ...
 * @public
 */
export declare function dict<Key extends string, Value>(keyValidator: Validatable<Key>, valueValidator: Validatable<Value>): DictValidator<Key, Value>;
/**
 ...
 * @public
 */
export declare function union<Key extends string, Config extends UnionValidatorConfig<Key, Config>>(key: Key, config: Config): UnionValidator<Key, Config>;
/**
...
/** @public */
export declare function nullable<T>(validator: Validatable<T>): Validator<null | T>;
/** @public */
export declare function literalEnum<const Values extends readonly unknown[]>(...values: Values): Validator<Values[number]>;
export {};
