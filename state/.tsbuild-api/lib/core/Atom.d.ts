 ...
 * @internal
 */
export declare class _Atom<Value, Diff = unknown> implements Atom<Value, Diff> {
    readonly name: string;
    private current;
    constructor(name: string, current: Value, options?: AtomOptions<Value, Diff>);
    readonly isEqual: ((a: any, b: any) => boolean) | null;
    computeDiff?: ComputeDiff<Value, Diff>;
