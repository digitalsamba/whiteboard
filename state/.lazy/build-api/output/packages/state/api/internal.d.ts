...
/** @internal */
declare type Child = _Computed<any> | EffectScheduler<any>;
...
declare class _Computed<Value, Diff = unknown> implements Computed<Value, Diff> {
     ...
     * The function that computes the value of the signal.
     */
    derive: (previousValue: UNINITIALIZED | Value, lastComputedEpoch: number) => Value | WithDiff<Value, Diff>, options?: ComputedOptions<Value, Diff>);
 ...
 * @internal
 */
declare class HistoryBuffer<Diff> {
...
/** @internal */
export declare function useStateTracking<T>(name: string, render: () => T): T;
