 ...
 * editor.
 */
export declare function useFixSafariDoubleTapZoomPencilEvents(ref: React.RefObject<HTMLElement>): void;
//# sourceMappingURL=useFixSafariDoubleTapZoomPencilEvents.d.ts.map