...
export declare class Editor extends EventEmitter<TLEventMap> {
     ...
     * @public
     */
    updateCurrentPageState(partial: Partial<Omit<TLInstancePageState, 'selectedShapeIds' | 'editingShapeId' | 'pageId' | 'focusedGroupId'>>, historyOptions?: TLCommandHistoryOptions): this;
    /** @internal */
     ...
     * @public
     */
    setSelectedShapes(shapes: TLShapeId[] | TLShape[], historyOptions?: TLCommandHistoryOptions): this;
    /** @internal */
     ...
     * @readonly
     */
    get onlySelectedShape(): TLShape | null;
    /**
     ...
     * @public
     */
    get editingShapeId(): TLShapeId | null;
    /**
     ...
     * @public
     */
    get hoveredShapeId(): TLShapeId | null;
    /**
     ...
     * @public
     */
    get croppingShapeId(): TLShapeId | null;
    /**
     ...
     * @public
     */
    renamePage(page: TLPageId | TLPage, name: string, historyOptions?: TLCommandHistoryOptions): this;
    /** @internal */
    private get _assets();
    /**
     ...
     * @public
     */
    get assets(): (TLImageAsset | TLVideoAsset | import("@tldraw/tlschema").TLBookmarkAsset)[];
    /**
     ...
     * @public
     */
    reparentShapes(shapes: TLShapeId[] | TLShape[], parentId: TLParentId, insertIndex?: string): this;
    /**
     ...
     * @param historyOptions - (optional) The history options for the change.
     */
    nudgeShapes(shapes: TLShapeId[] | TLShape[], offset: VecLike, historyOptions?: TLCommandHistoryOptions): this;
    /**
     * Duplicate shapes.
     *
     * @example
     ...
     * @public
     */
    resizeShape(shape: TLShapeId | TLShape, scale: VecLike, options?: TLResizeShapeOptions): this;
    /** @internal */
     ...
     * @public
     */
    animateShape(partial: TLShapePartial | null | undefined, animationOptions?: TLAnimationOptions): this;
    /**
     * Animate shapes.
     *
     * @example
     ...
     * @public
     */
    animateShapes(partials: (TLShapePartial | null | undefined)[], animationOptions?: Partial<{
        duration: number;
        easing: (t: number) => number;
    }>): this;
    /**
     ...
     * @public
     */
    groupShapes(shapes: TLShapeId[] | TLShape[], groupId?: TLShapeId): this;
    /**
     * Ungroup some shapes.
     *
     ...
     * @public
     */
    updateShape<T extends TLUnknownShape>(partial: TLShapePartial<T> | null | undefined, historyOptions?: TLCommandHistoryOptions): this;
    /**
     ...
     * @public
     */
    updateShapes<T extends TLUnknownShape>(partials: (TLShapePartial<T> | null | undefined)[], historyOptions?: TLCommandHistoryOptions): this;
    /** @internal */
    ...
    externalAssetContentHandlers: {
        [K in TLExternalAssetContent['type']]: {
            [Key in K]: null | ((info: TLExternalAssetContent & {
                type: Key;
     ...
     * @public
     */
    registerExternalAssetHandler<T extends TLExternalAssetContent['type']>(type: T, handler: null | ((info: TLExternalAssetContent & {
        type: T;
    ...
    externalContentHandlers: {
        [K in TLExternalContent['type']]: {
            [Key in K]: null | ((info: TLExternalContent & {
                type: Key;
            }) => void);
        }[K];
    };
     ...
     * @public
     */
    registerExternalContentHandler<T extends TLExternalContent['type']>(type: T, handler: null | ((info: T extends TLExternalContent['type'] ? TLExternalContent & {
        type: T;
    } : TLExternalContent) => void)): this;
    /**
     ...
     * @public
     */
    getSvg(shapes: TLShapeId[] | TLShape[], opts?: Partial<{
        scale: number;
        background: boolean;
        padding: number;
