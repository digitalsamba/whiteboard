...
/** @public */
export type TLPointerEventName = 'pointer_down' | 'pointer_move' | 'pointer_up' | 'right_click' | 'middle_click';
/** @public */
...
/** @public */
export type TLEventName = TLPointerEventName | TLCLickEventName | TLPinchEventName | TLKeyboardEventName | 'wheel' | 'cancel' | 'complete' | 'interrupt';
/** @public */
...
/** @public */
export type TLEventInfo = TLPointerEventInfo | TLClickEventInfo | TLKeyboardEventInfo | TLPinchEventInfo | TLWheelEventInfo | TLCancelEventInfo | TLCompleteEventInfo | TLInterruptEventInfo;
/** @public */
