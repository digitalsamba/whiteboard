...
/** @public */
export type TLRecord = TLAsset | TLCamera | TLDocument | TLInstance | TLInstancePageState | TLPage | TLShape | TLInstancePresence | TLPointer;
//# sourceMappingURL=TLRecord.d.ts.map